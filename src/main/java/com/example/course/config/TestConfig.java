...
@Configuration
@Profile("test") // Informar que é exclusiva de teste, o nome tem que ser igual ao definido no
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Associação entre os objetos Products and Category
		...
		//Não será necessário criar o repositório de Pagamento, quem irá salvar em memória será o JPA
		o1.setPayment(pay1);
		
		//Dessa forma salvando novamente o pedido
